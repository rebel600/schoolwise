...
Contrast: unlike Journey, you do not finish the whole submission experience before touching teams; you run a thin version of the _entire_ loop first, then thicken every segment.
