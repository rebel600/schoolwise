...
Remove duplicates, then **filter to source files** to sync _from_:
...
- **Keep the `D` (deleted) entries** in a separate list; they drive orphan cleanup (Step 3) though they aren't synced _from_.
